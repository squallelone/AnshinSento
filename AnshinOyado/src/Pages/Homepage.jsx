...
export function Home() {
  return (
    <>
        ...
        <div class="column">
          <div class="three">
            <h1>
              ...
              <span id="greenboldFont">Sento, Lounge and Capsule</span>
            </h1>{" "}
          </div>
      ...
      <div className="card">
        <Link to="/context">
          <button type="button">Discover the experience</button>
        </Link>
      </div>
      ...
      <p>
        A price that is meant to be affordable but efficient. Starting from 12
        euros for a set of 2 hours, confortable enough for bathing or taking a
        rest. Please see simulation here
      </p>
