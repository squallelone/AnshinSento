...
export function Activitiespage() {
  ...
  <a href="#contact"><Link to="/contact">Contact</Link></a>
    ...
    <a href="https://vite.dev" target="_blank">
        ...
        <img src={AnshinLogo} className="photo"  alt="Vite logo" />
            ...
            <p>
            Within one day you can go through all pleasant activities - please see an example of what could be done in Anshin Sento. It is meant to be just an example, and flexible through the duration taken based on your own needs.
           </p>
  ...
  <tr>              
    ...
    <td>16:00 </td>
    <td>Capsule</td>
    <td>You start to be tired and decide to go to your capsule to take a nap and rest</td>
                </tr>
                <tr>
<td>17:00 </td>
    <td>Outside</td>
    <td> You decide to take a walk and have a dinner outside </td>
        ...
        <td>21:00 </td>
    <td>Shower </td>
    <td> After this long day, you take a shower before going to the Sento </td>
                </tr>     
                        <tr>
                    <td>21:30 </td>
    <td>Sento </td>
    <td> you finally enjoy the Sento. It is hot and you regularly take some water outside the Sento </td>
                </tr>
                <tr>
                  <td>22:15 </td>
    <td>Sauna </td>
    <td> Enjoying the experience to the fullest </td>
                  ...
                  <td>23:00 </td>
    <td>Capsule </td>
    <td> Relaxed, you get to your own clean capsule and sleep happily. </td>
                </tr> 
</table>
